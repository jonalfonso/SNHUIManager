...
public class MyContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.example.inventoryapp.provider.MyContentProvider";
        ...
        switch (uriType) {
            ...
            case PRODUCTS_ID:
                ...
                if(TextUtils.isEmpty(selection)) {
                    ...
                    rowsDeleted = sqlDB.delete(MyDBHandler.TABLE_PRODUCTS,MyDBHandler.COLUMN_ID + "=" + id + " and " +
        ...
        switch(uriType) {
            ...
            case PRODUCTS_ID:
                ...
                if(TextUtils.isEmpty(selection)){
                    ...
                    rowsUpdated = sqlDB.update(MyDBHandler.TABLE_PRODUCTS, values,MyDBHandler.COLUMN_ID + "="+id + " and " +
                            selection,selectionArgs);
                }
                break;
            default:
